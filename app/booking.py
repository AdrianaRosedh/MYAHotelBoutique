...
def booking():
    try:
        ...
        required_fields = ['first_name', 'last_name', 'email', 'checkin', 'checkout', 'guests']
        ...
        logging.debug(f"Extracted data: first_name={first_name}, last_name={last_name}, email={email}, checkin={checkin}, checkout={checkout}, guests={guests}")
        ...
        return jsonify(success=False, error=str(http_err)), http_err.response.status_code
